...
function ParticipantRegisterModal() {
  ...
  return (
    <>
      <Button
        className="participant-register-button hidden-xs"
        onClick={handleShow}
      >
        ĐĂNG KÝ CHUYÊN VIÊN
      </Button>
      <Button
        className="participant-register-button block-xs"
        onClick={handleShow}
      >
        ĐĂNG KÝ
      </Button>
      ...
      >
        <Modal.Header>
          <div className="participant-modal-header">
            ĐĂNG KÝ SỬ DỤNG DỊCH VỤ TƯ VẤN CHUYÊN VIÊN
          </div>
        </Modal.Header>
        <Modal.Body>
          <Container fluid>
